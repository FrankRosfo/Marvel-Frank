...
class GeneralController extends Controller
{
    ...
    public function inicio(){
        ...
        // -- consumir api Marvel
        $cliente = new \GuzzleHttp\Client();
        $response = $cliente->request('GET', 'https://gateway.marvel.com:443/v1/public/comics?limit=20&offset='.$numero.'&ts=1&apikey=06ffa280d1bafc06d930b43d6d8dd14b&hash=afda8720864a69268e1e8bedd7a23b60');
        $datos_comic = json_decode($response->getBody()->getContents(), true);
        ...
        return view('index',['personajes' => $personajes, 'comics' => $comics]);
    }
